# Score-Entropy-Discrete-Diffusion-Char
The goal is to train SEDD on a char-level dataset, especially for uniform-rate CTMC

## Score Entropy Discrete Diffusion

This repo is built upon a PyTorch implementation for the paper [Discrete Diffusion Modeling by Estimating the Ratios of the Data Distribution
